        ...
        <div class="leaveOption">
            ...
            <div class="form-group col-12" style="display:none">
                ...
                <div id="same2">
                    ...
                    <input type="text" placeholder="Specify" class="form-control" id="specification" name="specification" value="{{$lf_employee['specification']}}" style="width: 1050" disabled>
                </div>
            </div>
            ...
            if (status == "Approved") {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/employeeHead/' + $('#approve_form').attr("data-id"),
                            method: "POST",
                            processData: false,
                            contentType: false,
                            cache: false,
